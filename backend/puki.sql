...
CREATE TABLE IF NOT EXISTS `floor_roster` (
  `date` date  NOT NULL,
  `floor` int NOT NULL,
  `assigned_housekeeper` varchar(32) NOT NULL REFERENCES `housekeeper`,
  PRIMARY KEY (`date`, `floor`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

CREATE TABLE IF NOT EXISTS `rooms_roster` (
  `date` date  NOT NULL,
